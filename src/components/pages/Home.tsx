...
export default function Home(){
    ...
    return(
        ...
        <div data-aos="fade-down" className=' h-auto md:mt-44 mt-52 md:ml-16 md:w-1/3 relative'>
           ...
           <div className='bg-white w-10 mt-0 h-10'>

           </div>
           <div className='h-10 w-14 bg-green-500 mt-0'>
            <AiFillCaretDown style={{color:'white'}} size={30} className='ml-3 mt-2' />
           </div>
           </div>
           </div>
           <div className='mt-2'>
           ...
           <div className='mt-0 h-36 w-5/6 ml-5 md:ml-0 md:w-full  flex'>
            ...
            <div className='h-36 w-1/3'>
             ...
             <div className='h-11 w-full mt-4 bg-white'>
             <input type="text" className='h-full w-full rounded-sm px-4 outline-none mt-0' placeholder='Your Prices'  />

             </div>
            </div>
            <div className='h-36 md:mt-0 w-2/3 border-2 rounded-sm border-gray-400 ml-2'>

            </div>
           </div>
            <div className='flex ml-44 md:ml-56'>
                <div className=''>
                <button onClick={HideContent} className='h-8 rounded-sm w-24 md:w-32 md:ml-0 ml-2 mt-2 bg-gold text-white'>Abort</button>

                </div>
                <div className='ml-2 mb-4'>
                <button onClick={HideContent} className='h-8 rounded-sm w-24 md:w-32 md:ml-0 ml-2 mt-2 bg-green-500 text-white'>Submit</button>
        ...
        {wnd?
            ...
            <div className='h-14 w-full mt-2  flex '>
                ...
                <div className='h-14 w-3/6 border-2 border-gold ml-4'>
                    <a>
                    <button onClick={showContent} className='md:ml-20 ml-10 text-white pt-3 text-base md:text-xl font-bold md:pt-2.5'>Hire a pro freelancer</button>
                    </a>
                </div>
